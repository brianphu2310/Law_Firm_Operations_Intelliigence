...
def render_overview():
    ...
    with card():
        ...
        with fc1:
            ...
            fig_funnel.update_layout(
                margin=dict(l=8, r=8, t=6, b=6), height=165,
                paper_bgcolor="rgba(0,0,0,0)",
    ...
    with col_trend:
        with card():
            ...
            fig.update_layout(**plotly_base(165), hovermode="x unified", barmode="group", bargap=0.3, bargroupgap=0.15)
    ...
    with col_country:
        with card():
            ...
            st.plotly_chart(revenue_stream_fig(height=155), width="stretch",
