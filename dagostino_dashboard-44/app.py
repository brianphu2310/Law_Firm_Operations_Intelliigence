...
def render_overview():
    ...
    with card():
        pc1, pc2, pc3, pc4, pc5 = st.columns([1.15, 0.85, 0.85, 1.0, 1.35])
        with pc1:
            st.markdown(
        ...
        with pc5:
            ...
            fig_radar.update_layout(
                margin=dict(l=6, r=6, t=4, b=4), height=95,
                paper_bgcolor="rgba(0,0,0,0)",
                ...
                polar=dict(
                    ...
                    angularaxis=dict(gridcolor="#eef2f3", linecolor="#eef2f3", showticklabels=False, ticks=""),
                ),
                showlegend=False,
            )
