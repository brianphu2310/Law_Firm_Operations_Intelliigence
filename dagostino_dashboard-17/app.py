...
div[class*="st-key-cardblock_"] {{
    ...
    box-shadow: 0 6px 20px rgba(15,23,42,0.11), 0 1.5px 4px rgba(15,23,42,0.06) !important;
...
.kpi-card {{ background:{CARD}; border:1px solid {BORDER}; border-radius:16px; padding:8px 14px; height:100%; box-shadow: 0 6px 18px rgba(15,23,42,0.10), 0 1.5px 3px rgba(15,23,42,0.05); }}
.kpi-label {{ font-size:11.5px; font-weight:500; color:{MUTED}; margin-bottom:3px; }}
...
.kpi-trend {{ display:flex; align-items:center; gap:4px; margin-top:1px; }}
