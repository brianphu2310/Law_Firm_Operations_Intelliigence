    ...
    with tabs[1]:
        ...
        with c2:
            with ui.card("c3"):
                ...
                gsum = g.sum() or 1.0
                leg = "".join(f'<div class="donut-legend-item" style="margin-bottom:0;"><span class="legend-dot" style="background:{AREA_COLORS[a]}"></span>{a} ({g[a] / gsum:.0%})</div>' for a in g.index)
