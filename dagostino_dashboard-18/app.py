...
.kpi-card {{ background:{CARD}; border:1px solid {BORDER}; border-radius:16px; padding:8px 14px; height:100%; box-shadow: 0 10px 26px rgba(15,23,42,0.18), 0 3px 7px rgba(15,23,42,0.11); }}
