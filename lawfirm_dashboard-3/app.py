"""
Apex Legal — Operations Dashboard (full practice-management build)
...
div[data-testid="stVerticalBlockBorderWrapper"] > div {{
    ...
    box-shadow: 0 1px 2px rgba(15,23,42,0.04); border: 1px solid {BORDER} !important;
}}
...
.section-title {{ font-size:20px; font-weight:800; color:{INK}; margin: 4px 0 2px 0; }}
.section-sub {{ font-size:13px; color:{MUTED}; margin-bottom: 14px; }}
...
.attorney-card {{ background:{CARD}; border:1px solid {BORDER}; border-radius:16px; padding:16px; text-align:center; }}
.attorney-avatar {{
    width:48px; height:48px; border-radius:24px; background:{TEAL}; color:#fff;
    font-weight:700; font-size:15px; display:flex; align-items:center; justify-content:center;
    margin: 0 auto 10px auto;
}}

.branch-card {{ background:{CARD}; border:1px solid {BORDER}; border-radius:16px; padding:16px; }}
.branch-name {{ font-size:15px; font-weight:700; color:{INK}; }}
.branch-council {{ font-size:11px; color:{MUTED}; margin-bottom:10px; }}
</style>
"""
...
BRANCHES = [
    {"name": "Richmond", "lat": -33.6003, "lon": 150.7514, "council": "Hawkesbury City Council",
     "headcount": 4, "active_matters": 11, "monthly_revenue": 132000, "monthly_cost": 94000},
    {"name": "Camden", "lat": -34.0489, "lon": 150.6993, "council": "Camden Council",
     "headcount": 5, "active_matters": 15, "monthly_revenue": 168000, "monthly_cost": 121000},
    {"name": "Liverpool", "lat": -33.9209, "lon": 150.8809, "council": "Liverpool City Council",
     "headcount": 6, "active_matters": 18, "monthly_revenue": 193000, "monthly_cost": 138000},
]
...
CLIENTS = [
    {"name": "Acme Corp", "practice": "Litigation", "attorney": "Zane, R.", "billed": 612000, "matters": 4, "since": 2019},
    {"name": "Zenith Labs", "practice": "Litigation", "attorney": "Specter, H.", "billed": 390000, "matters": 2, "since": 2021},
    {"name": "Meridian Holdings Ltd.", "practice": "Corporate", "attorney": "Sterling, C.", "billed": 540000, "matters": 5, "since": 2017},
    {"name": "Global Trust Bank", "practice": "Corporate", "attorney": "Specter, H.", "billed": 475000, "matters": 3, "since": 2020},
    {"name": "Vertex Industries", "practice": "IP Portfolio", "attorney": "Litt, L.", "billed": 268000, "matters": 6, "since": 2018},
    {"name": "Harlow & Co.", "practice": "Employment", "attorney": "Sterling, C.", "billed": 142000, "matters": 2, "since": 2022},
    {"name": "Nova Materials", "practice": "IP Portfolio", "attorney": "Litt, L.", "billed": 198000, "matters": 3, "since": 2020},
    {"name": "Bright Path Foundation", "practice": "Advisory", "attorney": "Sterling, C.", "billed": 86000, "matters": 1, "since": 2023},
]
...
with st.container(border=True):
    ...
    with brand_col:
        st.markdown(
            ...
            '<div class="brand-name">Apex Legal</div></div>',
