...
.st-key-topbar div[data-testid="stVerticalBlockBorderWrapper"] > div {{
    background:{TEAL} !important; border:none !important; box-shadow:none !important;
}}
.st-key-topbar .brand-badge {{ background:#ffffff !important; color:{TEAL} !important; }}
.st-key-topbar .brand-name {{ color:#ffffff !important; }}
.st-key-topbar .avatar-initials {{ background:#ffffff !important; color:{TEAL} !important; }}
.st-key-topbar .user-name {{ color:#ffffff !important; }}
.st-key-topbar .user-role {{ color:rgba(255,255,255,0.75) !important; }}
.st-key-topbar div[data-testid="stButton"] button {{ color:{TEAL_TINT} !important; }}
