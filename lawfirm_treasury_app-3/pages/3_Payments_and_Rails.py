...
with left:
    ...
    if len(infotrack_f):
        ...
        fig = px.pie(by_src, names="paid_from", values="amount", hole=0.45, color_discrete_sequence=PALETTE)
...
with right:
    ...
    if len(rapidpay_f):
        ...
        fig2 = px.box(rp, x="payment_method", y="fee_rate_%", points="all", color_discrete_sequence=PALETTE)
...
fig3 = px.line(recon_month, x="period_end", y=["bank_balance", "ledger_balance"], markers=True, color_discrete_sequence=PALETTE)
