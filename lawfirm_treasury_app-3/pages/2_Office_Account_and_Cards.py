...
with left:
    ...
    fig = px.bar(o_month, x="month", y="amount", color="type", barmode="relative", color_discrete_sequence=PALETTE)
...
with right:
    ...
    if len(cards_f):
        ...
        fig2 = px.bar(by_charge, x="card_type", y="amount", color="charged_to", barmode="group", color_discrete_sequence=PALETTE)
