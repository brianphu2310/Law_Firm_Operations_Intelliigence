...
from utils import inject_theme, PALETTE, load_all, sidebar_filters
...
with right:
    ...
    fig2 = px.pie(ct, names="client_type", values="count", hole=0.45, color_discrete_sequence=PALETTE)
...
if len(briefed):
    ...
    fig3 = px.bar(by_counsel.sort_values("matters", ascending=False), x="counsel_name", y="matters", color="specialty", color_discrete_sequence=PALETTE)
