...
from utils import load_all, money, inject_theme, insight_card, PALETTE

st.set_page_config(page_title="Relationships & Locations", page_icon="🗺️", layout="wide")
inject_theme()

st.title("🗺️ Relationships & Locations")
st.caption(
    "How office account, trust account, cards, InfoTrack, LEAP, RapidPay, CommBiz and commission "
    "relate to each other — and how it all rolls up by matter location."
)
