...
def branch_globe_fig(height=195):
...
with st.sidebar:
    ...
    fig_side.update_layout(
        margin=dict(l=8, r=8, t=8, b=8), height=185,
...
def render_overview():
    ...
    with card():
        ...
        with fc1:
            ...
            fig_funnel.update_layout(
                margin=dict(l=8, r=8, t=6, b=6), height=170,
                paper_bgcolor="rgba(0,0,0,0)",
    ...
    with col_trend:
        with card():
            ...
            fig.update_layout(**plotly_base(170), hovermode="x unified", barmode="group", bargap=0.3, bargroupgap=0.15)
    ...
    with col_country:
        with card():
            ...
            st.plotly_chart(revenue_stream_fig(height=160), width="stretch",
                             config={"displayModeBar": False})

    with col_map:
        st.markdown('<div class="card-title" style="padding:4px 2px 0 2px; text-align:center;">Global Matter Footprint</div>',
                    unsafe_allow_html=True)
        globe_fig, total_matters, num_countries = branch_globe_fig(height=195)
